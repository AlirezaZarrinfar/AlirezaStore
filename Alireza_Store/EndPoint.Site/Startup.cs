...
using Alireza_Store.Application.Services.Users.FacadPattern;
...
namespace EndPoint.Site
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string ConnectionString = @"Data Source=.; Initial Catalog=Alireza_StoreDb; Integrated Security=True;";
